...
| **Inpainting (with mask)** | `+ image_urls + mask_url + action: edit` | The [GPT Image official](/en/api-reference/image/gpt-image/overview) models; **not supported** on the GPT Image reverse lines or the Nano Banana economy routes |
