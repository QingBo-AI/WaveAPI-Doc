...
| `qwen3.8-max-0902` | + cache read | ✓ / ✓ |
| `qwen3.8-2.4t-a95b` | input + output | ✓ / ✓ |
| `qwen3.8-27b` | input + output | — / ✓ |
| `qwen3.8-flash` | input + output | ✓ / ✓ |
| `qwen3.7-max` | input + output | ✓ / ✓ |
| `qwen3.7-plus` | input + output | ✓ / ✓ |
| `qwen3.7-flash` | input + output | ✓ / ✓ |
...
- `qwen3.8-max-0902` — max input 983K, max output 131K; supports automatic cache hits; explicit `cache_control` is not supported; use `tool_choice: "auto"`
- `qwen3.8-2.4t-a95b` — use `tool_choice: "auto"`
- `qwen3.8-27b` — use `tool_choice: "auto"`
- `qwen3.8-flash` — use `tool_choice: "auto"`
- `qwen3.7-plus` — 256K long-context tier
- `qwen3.7-flash` — 32K long-context tier
