...
- `qwen3.8-2.4t-a95b` — has a separate cache-write rate; use `tool_choice: "auto"`
- `qwen3.8-27b` — has a separate cache-write rate; use `tool_choice: "auto"`
- `qwen3.8-flash` — has a separate cache-write rate; use `tool_choice: "auto"`
- `qwen3.7-plus` — 256K long-context tier
- `qwen3.7-flash` — 32K long-context tier; has a separate cache-write rate
