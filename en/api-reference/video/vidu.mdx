...
| `vidu-q3` `vidu-q3-mix` | Per request | `image_urls` is required, up to 7 images |
...
`generate_audio`, `seed`, the aspect ratio and the number of reference images do not affect the price. Without `resolution` the `720p` default tier applies.
...
|---|---|---|---|---|
| `vidu-q3` | `540p` `720p` `1080p` | 3–16 | 1–7 reference images, required | Reference-to-video that keeps referenced subjects consistent, multi-shot cutting |
| `vidu-q3-mix` | `720p` `1080p` | 1–16 | 1–7 reference images, required | Blends several references into one coherent clip |
