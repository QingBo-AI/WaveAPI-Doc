...
| **Video continuation** | `video_urls` (single clip) or `ref_task_id` | Omni / FLUX 3 Video / Veo reverse tiers (`extend`) / Seedance 2.5 (`extend`) / SkyReels V4 (`extend`) / PixVerse V6 (`extend`) |
| **Video editing (EDIT)** | `video_urls + prompt` (optionally `image_urls` as style reference) | Wan VideoEdit / HappyHorse 1.0 / Seedance 2.5 / Kling v3 Omni · Video O1 / Grok Imagine Video |
