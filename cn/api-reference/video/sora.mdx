...
<Warning>
`sora-2` 与 `sora-2-pro` 已于 2026-09-24 下架（OpenAI 关停 Sora 2 全部模型与 Videos API），本页仅作存档，调用将返回错误。视频生成请改用 [Veo 3.1 系列](/cn/api-reference/video/veo) 或 [视频模型总览](/cn/api-reference/video/overview) 中的其他模型
</Warning>
