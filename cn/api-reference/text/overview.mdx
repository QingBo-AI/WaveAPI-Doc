...
|---|---|:---:|
| `qwen3.8-max` | 含缓存读 | ✓ / ✓ |
| `qwen3.8-max-0902` | 含缓存读 | ✓ / ✓ |
| `qwen3.8-2.4t-a95b` | 输入输出两项 | ✓ / ✓ |
| `qwen3.8-27b` | 输入输出两项 | — / ✓ |
| `qwen3.8-flash` | 输入输出两项 | ✓ / ✓ |
| `qwen3.7-max` | 输入输出两项 | ✓ / ✓ |
| `qwen3.7-plus` | 输入输出两项 | ✓ / ✓ |
| `qwen3.7-flash` | 输入输出两项 | ✓ / ✓ |
| `qwen3.6-plus` | 输入输出两项 | — / ✓ |
...
- `qwen3.8-max-0902` — 最大输入 983K、最大输出 131K；支持自动缓存命中；不支持显式 `cache_control`；`tool_choice` 用 `"auto"`
- `qwen3.8-2.4t-a95b` — `tool_choice` 用 `"auto"`
- `qwen3.8-27b` — `tool_choice` 用 `"auto"`
- `qwen3.8-flash` — `tool_choice` 用 `"auto"`
- `qwen3.7-plus` — 256K 长上下文分档
- `qwen3.7-flash` — 32K 长上下文分档
