...
MODELS = [
 ...
 m("qwen3.8-max-0902","qwen",1.485,4.4559,cr=0.1854,ver="TSJFC",limits=("983K","131K"),notes=["不支持显式 `cache_control`","`tool_choice` 用 `\"auto\"`"],notes_en=["explicit `cache_control` is not supported","use `tool_choice: \"auto\"`"]),
 m("qwen3.8-2.4t-a95b","qwen",1.485,4.4559,ver="TSJF",notes=["`tool_choice` 用 `\"auto\"`"],notes_en=["use `tool_choice: \"auto\"`"]),
 m("qwen3.8-27b","qwen",0.3816,1.5264,ver="TSF",notes=["`tool_choice` 用 `\"auto\"`"],notes_en=["use `tool_choice: \"auto\"`"]),
 m("qwen3.8-flash","qwen",0.1017,0.3438,ver="TSJF",notes=["`tool_choice` 用 `\"auto\"`"],notes_en=["use `tool_choice: \"auto\"`"]),
 ...
 m("qwen3.7-flash","qwen",0.0252,0.099,tier=dict(th="32K",op=">",inp=0.0747,out=0.297),ver="TSJF"),
