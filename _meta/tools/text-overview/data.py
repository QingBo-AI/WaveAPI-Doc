...
def m(id, vendor, inp, out, cr=None, cw=None, cw5=None, cw1=None, tier=None, ver="TS", proto="chat",
      limits=None, notes=None, notes_en=None, sched=False, ws=None):
    return dict(id=id, vendor=vendor, price=dict(inp=inp, out=out, cr=cr, cw=cw, cw5=cw5, cw1=cw1),
                tier=tier, ver=ver, proto=proto, limits=limits, notes=notes or [], notes_en=notes_en or [], sched=sched, ws=ws)
...
MODELS = [
 ...
 m("gpt-5.6-luna","openai",0.18,1.08,cr=0.018,cw=0.225,tier=dict(T272,inp=0.36,out=1.62,cr=0.036,cw=0.45),ws=9,ver="TSJFC",limits=("922K","128K"),
   ),
 m("gpt-5.6-terra","openai",1.80,10.80,cr=0.18,cw=2.25,tier=dict(T272,inp=3.60,out=16.20,cr=0.36,cw=4.50),ws=9,ver="TSJF",limits=("922K","12.8K")),
 m("gpt-5.6-sol","openai",3.60,18.00,cr=0.36,cw=4.50,tier=dict(T272,inp=7.20,out=27.00,cr=0.72,cw=9.00),ws=9,ver="TSJF",limits=("922K","12.8K"),
   notes=[],notes_en=[]),
 m("gpt-5.5","openai",4.50,27.00,cr=0.45,tier=dict(T272,inp=9.00,out=40.50,cr=0.90),ws=9,ver="TSJF",limits=("1M","12.8K"),
   notes=["无独立缓存写入价"],notes_en=["No separate cache-write rate"]),
 m("gpt-5.4","openai",2.25,13.50,cr=0.225,tier=dict(T272,inp=4.50,out=20.25,cr=0.45),ws=9,ver="TSJF",limits=("1M","12.8K"),
   notes=["无独立缓存写入价"],notes_en=["No separate cache-write rate"]),
 m("gpt-5.4-pro","openai",27,162,tier=dict(T272,inp=54,out=243),ws=9,ver="rTrS",proto="responses"),
 m("gpt-5.4-mini","openai",0.675,4.05,cr=0.0675,ws=9,ver="TSJFC"),
 m("gpt-5.4-nano","openai",0.18,1.125,cr=0.018,ws=9,ver="TSJFC"),
 m("gpt-5.3-codex","openai",1.575,12.6,ws=9,ver="rTrS",proto="responses"),
 m("gpt-5.2","openai",1.575,12.6,cr=0.1575,ws=9,ver="TSJFC"),
 m("gpt-5.2-pro","openai",18.9,151.2,ws=9,ver="rTrS",proto="responses"),
 m("gpt-5.1","openai",1.125,9,cr=0.1125,ws=9,ver="TSJFC"),
 m("gpt-5","openai",1.125,9,cr=0.1125,ws=9,ver="TSFC"),
 m("gpt-5-mini","openai",0.225,1.8,cr=0.0225,ws=9,ver="TSJFC"),
 m("gpt-5-nano","openai",0.045,0.36,cr=0.0045,ws=9,ver="TSJFC"),
 m("gpt-5-pro","openai",13.5,108,ws=9,ver="rTrS",proto="responses"),
 ...
 m("o3","openai",1.8,7.2,ws=9,ver="TSJF"),
 m("o3-pro","openai",18,72,ws=9,ver="rTrS",proto="responses"),
 m("o4-mini","openai",0.99,3.96,cr=0.2475,ws=9,ver="TSJFC"),
 m("o3-mini","openai",0.99,3.96,cr=0.495,ver="TSJFC"),
 m("o1","openai",13.5,54,cr=6.75,ver="TSJFC"),
 # ---------- Anthropic ----------
 m("claude-fable-5-1","anthropic",9.00,45.00,cr=0.225,cw5=11.25,cw1=18.00,ws=9,ver="TSF",limits=("1M","128K"),
 ...
 m("claude-fable-5","anthropic",9,45,cr=0.9,cw5=11.25,cw1=18,ws=9,ver="TSF",limits=("1M","128K"),
 ...
 m("claude-sonnet-5","anthropic",1.80,9.00,cr=0.18,cw5=2.25,cw1=3.60,ws=9,ver="TSF",limits=("1M","128K"),
   notes=["不支持 JSON Schema 与 `json_object`"],
   notes_en=["JSON Schema and `json_object` are not supported"]),
 m("claude-opus-4-8","anthropic",4.5,22.5,cr=0.45,cw5=5.625,cw1=9.00,ws=9,ver="TSF"),
 m("claude-opus-4-7","anthropic",4.5,22.5,cr=0.45,cw5=5.625,cw1=9.00,ws=9,ver="TSF"),
 m("claude-opus-4-6","anthropic",4.5,22.5,cr=0.45,cw5=5.625,cw1=10.00,ws=9,ver="TSF"),
 m("claude-opus-4-5","anthropic",4.5,22.5,ver="TSF"),
 m("claude-sonnet-4-6","anthropic",2.7,13.5,cr=0.27,cw5=3.375,cw1=5.40,ver="TSF"),
 m("claude-sonnet-4-5","anthropic",2.7,13.5,cr=0.27,cw5=3.375,cw1=5.40,ver="TSF"),
 m("claude-haiku-4-5","anthropic",0.9,4.5,cr=0.09,cw5=1.125,cw1=1.80,ws=9,ver="TSF"),
 # ---------- Google ----------
 ...
 # ---------- Qwen ----------
 m("qwen3.8-max","qwen",1.485,4.4559,cr=0.1854,cw=1.8567,ws=0.5143,ver="TSJFC",limits=("983K","131K"),notes=["`tool_choice` 用 `\"auto\"`"],notes_en=["use `tool_choice: \"auto\"`"]),
 m("qwen3.8-max-0902","qwen",1.485,4.4559,cr=0.1854,cw=1.8567,ws=0.5143,ver="TSJFC",limits=("983K","131K"),notes=["`tool_choice` 用 `\"auto\"`"],notes_en=["use `tool_choice: \"auto\"`"]),
 m("qwen3.8-2.4t-a95b","qwen",1.485,4.4559,cr=0.1854,cw=1.8567,ws=0.5143,ver="TSJFC",notes=["`tool_choice` 用 `\"auto\"`"],notes_en=["use `tool_choice: \"auto\"`"]),
 m("qwen3.8-27b","qwen",0.3816,1.5264,cr=0.0765,cw=0.477,ws=0.5143,ver="TSFC",notes=["`tool_choice` 用 `\"auto\"`"],notes_en=["use `tool_choice: \"auto\"`"]),
 m("qwen3.8-flash","qwen",0.1017,0.3438,cr=0.0126,cw=0.1593,ws=0.5143,ver="TSJFC",notes=["`tool_choice` 用 `\"auto\"`"],notes_en=["use `tool_choice: \"auto\"`"]),
 ...
 m("qwen3.7-flash","qwen",0.0252,0.099,cr=0.0054,cw=0.0306,tier=dict(th="32K",op=">",inp=0.0747,out=0.297,cr=0.0153,cw=0.0927),ws=0.5143,ver="TSJFC"),
